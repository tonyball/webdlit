(function() {
  'use strict';
  angular.module('newkruDlitApp', ['ngCookies', 'ngResource', 'ngSanitize', 'ngRoute', 'simplePagination', 'pw.canvas-painter', 'ngDragDrop', 'highcharts-ng', 'timer', 'ngFileUpload', 'angularRandomString', 'ngCkeditor']).config(function($routeProvider) {
